...
create_image_ac_feature_dataset(
    ...
    path_output='{}/data/train_catdog_rndembed_rate_ac_cover.csv'.format(path)
...
create_image_ac_feature_dataset(
    ...
    path_output='{}/data/train_catdog_rndembed_rate_ac_stego.csv'.format(path)
...
create_training_set(
    '{}/data/train_catdog_rndembed_rate_ac_cover.csv'.format(path),
    '{}/data/train_catdog_rndembed_rate_ac_stego.csv'.format(path),
    '{}/data/train_catdog_rndembed_rate_ac.csv'.format(path)
)
