...
if __name__ == '__main__':
    ...
    # t1 = train[train.image.str.contains('dog') & (train.label=='stego')].copy()
    # t2 = train[train.image.str.contains('cat') & (train.label=='cover')].copy()
    # train = pandas.concat([t1, t2])
    ...
    # train = train.drop([target, 'image', 'embedding_rate'], axis=1)
